...
sub export_data {
    ...
    my $datafile_name =  "CMSMC_J0004_V01_". $last_month_end ."_01_Z";
	my $exp_sql="select 
					cast(tjrq as varchar(7)), \
					cast(tzzfl as varchar(5)),\
					cast(cast(tzzsl as int) as varchar(30)),\
					cast(tzzslzb as varchar(8))\
				 from nspubview.CMSC_INVST_CNT_EDCT
                 where tjrq ="."'".$last_month."'";
	my $log_table = "nsptemp.fastexp_J0004_log";
