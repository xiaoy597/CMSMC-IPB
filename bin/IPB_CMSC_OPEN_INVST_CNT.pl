...
sub export_data {
    ...
    my $datafile_name =  "CMSMC_J0003_V01_". $last_month_end ."_01_Z";
	my $exp_sql="select cast(tjrq as varchar(7)),cast(pd as varchar(2)),cast(cast(zzrkhs as int) as varchar(30)),cast(cast(jgkhs as int) as varchar(30)) \
	from nspubview.CMSC_OPEN_INVST_CNT where tjrq = "."'".$last_month."'";
	my $log_table = "nsptemp.fastexp_J0003_log";
   ...
   my $ret = run_export($log_table,$log_file,$exp_sql);
    ...
    $ret = file_convert($data_file1, $data_file2);
