...
sub export_data {
    ...
    my $datafile_name =  "CMSMC_J0002_V01_". $last_month_end ."_01_Z";
	my $exp_sql="select cast(tjrq as varchar(7)), cast(cast(tzzzrs as int) as varchar(30)) from nspubview.CMSC_TOT_INVST_CNT where tjrq = "."'".$last_month."'";;
	my $log_table = "nsptemp.fastexp_J0002_log";
