...
sub export_data {
    ...
    my $datafile_name =  "CMSMC_J0001_V01_". $last_month_end ."_01_Z";
	my $exp_sql = "select cast(tjrq as varchar(7)),cast(cast(ssgsfhje as int) as varchar(30)) from nspubview.CMSC_LIST_COMP_DVD_AMT where tjrq = "."'".$last_month."'";
	my $log_table = "nsptemp.fastexp_J0001_log";
