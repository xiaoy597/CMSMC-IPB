...
sub export_data {
    ...
    my $datafile_name =  "CMSMC_J0007_V01_". $last_month_end ."_01_Z";
	my $exp_sql = "select \ 
				    cast(tjrq as varchar(7)), \ 
				    cast(cast(qhtzzs as int) as varchar(30)) \
				   from nspubview.CMSC_FUTRS_INVST_CNT \
				   where tjrq = "."'".$last_month."'";
	my $log_table = "nsptemp.fastexp_J0007_log";
