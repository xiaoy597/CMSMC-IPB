...
sub export_data {
    ...
    my $datafile_name =  "CMSMC_J0008_V01_". $last_month_end ."_01_Z";
		my $exp_sql = "select \ 
				     cast(tjrq as varchar(7)), \ 
				     cast(tzzfl as varchar(5)), \
                     cast(cast(qhtzzsl as int) as varchar(30)), \
                     cast(qhtzzslzb as varchar(8)) \
				   from nspubview.CMSC_FUTRS_INVST_CNT_EQT
				   where tjrq =" ."'".$last_month."'";
	my $log_table = "nsptemp.fastexp_J0008_log";
